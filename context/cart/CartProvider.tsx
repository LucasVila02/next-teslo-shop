...
const addProductToCart = (product: ICartProduct) =>{
    ...
    const productInCartButDifferectSize = state.cart.some( p => p._id === product._id && p.size === product.size );
    if(!productInCartButDifferectSize ) return dispatch({ type: 'Cart - Add Product', payload: [...state.cart, product]})
